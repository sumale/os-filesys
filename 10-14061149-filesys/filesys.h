...
#define FILESYS_H
#include<stddef.h>
#define DEVNAME "/home/xydf/data"                         
#define DIR_ENTRY_SIZE (32)
#define SECTOR_SIZE (512)
#define CLUSTER_SIZE (512*64)                         
#define FAT_ONE_OFFSET (512+512)                       
#define FAT_TWO_OFFSET (512+239*512+512)                       
#define ROOTDIR_OFFSET (512+239*512+239*512+512                     )
#define DATA_OFFSET (512+239*512+239*512+512*32+512)      
...
int fd_rm(char *dirName,int mode);
char *getFileContent();
