...
#include<stdio.h>
#include<time.h>
#define DEVNAME "/home/hanshiyi/data"
#define DIR_ENTRY_SIZE 32
#define SECTOR_SIZE 512
#define CLUSTER_SIZE 512*4
#define FAT_ONE_OFFSET 1024
#define FAT_TWO_OFFSET 1024+256*512
#define ROOTDIR_OFFSET 1024+256*512+256*512
#define DATA_OFFSET 1024+256*512+256*512+512*32
...
int fd_cf1(char *file_name,int size);
...
struct Entry *oldcur = NULL;
int dirno = 0;/*代表目录的层数*/
int olddirno;
struct Entry* fatherdir[10];
struct Entry* oldfatherdir[10];
