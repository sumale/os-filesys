...
/*
#define FAT_ONE_OFFSET 512
#define FAT_TWO_OFFSET 512+2*512       
#define ROOTDIR_OFFSET 512+2*512+2*512                 
#define DATA_OFFSET 512+2*512+2*512+512*32
*/
/*属性位掩码*/
...
//jsz add variable
int deletecount;//jsz add 将要删除的个数
int deletelist[512*250];//jsz add 递归删除的列表
//...
#endif
