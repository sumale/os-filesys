...
#define ROOTDIR_OFFSET 512+2*40*512
#define DATA_OFFSET 512+2*40*512+512*32
...
int v_fd_cd_path(char **path, int mode);
...
struct Entry *curdir = NULL, *v_curdir = NULL;
int dirno = 0, v_dirno = 0;/*代表目录的层数*/
struct Entry *fatherdir[10], *v_fatherdir[10];
